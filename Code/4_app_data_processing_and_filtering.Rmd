...
> **Please note:** Due to data privacy and ownership regulations, 
the raw data provided by Clue is not publicly available.
The processed and aggregated data, result of this section and the next one,
is provided on the github repository 
([https://github.com/lasy/Seasonality-Public-Repo](https://github.com/lasy/Seasonality-Public-Repo)) 
within `../Data/4_clue_data_aggregated`,
such that subsequent analyses (i.e., after section \@ref(clue-agg-data)) 
can be reproduced. 
