...
load(file = str_c(IO$p_outputs,"Rdata/sex_models.Rdata"), verbose = TRUE)
...
ok = foreach(ca = cas) %do% {
  ...
  j = which((sex_models_df$country_area == ca) & (sex_models_df$BC == "all") & (sex_models_df$age_cat == "all") & (sex_models_df$sex_type == "unprot_sex"))
